...
class PDFtoSummary:
    ...
    def create_retriever(self, pdf_loaded) -> VectorStoreRetriever:
        ...
        Returns:
            VectorStoreRetriever: A retriever object for performing semantic searches on the document embeddings.
        """
        ...
        self.retriever = db.as_retriever(search_kwargs={"k": 20})

        return self.retriever

    def question_answer(self, query, qa_chain) -> str:
    ...
    def summarize(self, qa_chain) -> str:
